...
def db_insert(res):
    try:
        conn = pymysql.connect(host='localhost', user='root',
                       password='알아서',db='stock',charset='utf8')
        sql_state = """INSERT INTO stock.daily_market(dt, item_name, item_code, price, foreign_ownership_ratio, rel_return,
